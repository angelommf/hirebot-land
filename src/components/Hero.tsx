    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden pattern-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-6 opacity-0 animate-fade-up text-center" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            <span className="text-[#0A3C5F]">Find & Retain</span> Your Most Valuable People
          </h1>
          
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8 opacity-0 animate-fade-up text-center" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
