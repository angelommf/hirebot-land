...
const Hero = () => {
  return (
    <section className="relative pt-20 pb-20 md:pt-28 md:pb-32 overflow-hidden pattern-bg">
      {/* Background overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#E6EFF6]/90 to-white/60 z-0"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Container for heading, subheading, and buttons */}
        <div className="flex flex-col items-center mb-10">
          {/* Removed the empty div that held the old logo */}

          {/* Small “Rethinking the Hiring Process” tag */}
          <div className="inline-block px-3 py-1 rounded-full bg-[#0A3C5F]/10 text-[#0A3C5F] text-sm font-medium mb-4 animate-fade-in">
